...
export default function AdminBlog() {
  ...
  const columns = [
    ...
    { key: 'slug', label: 'Slug', render: v => <span className="font-mono text-xs text-gray-400" dir="ltr">{v}</span> },
    ...
    { key: 'created', label: 'تاریخ', render: v => v ? new Date(v).toLocaleDateString('fa-IR') : '—' },
  ]
